...
// print(address);
  ...
  void showRequestingSheet({Address? pickUpAddress}) {
    ...
    if (availableDrivers.isNotEmpty){
      ...
      ..driverId = availableDrivers.first.id
      ...
      print(ride);
      createRide(ride,destinationAddress?.placeName,pickUpAddress?.placeName);
      return;
    }

    //else show a dialog indicating no drivers available
